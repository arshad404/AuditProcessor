...
public class ServiceAuditContextStore implements AuditContextStore<DefaultAuditContext> {
  ...
  public ServiceAuditContextStore(DefaultContextStore defaultContextStore) {
  ...
  public ServiceAuditContextStore(ObjectMapper objectMapper) {
  ...
  public void setAuditContext(Object object, Response response, Type type)
    ...
    try {
      ...
      throw new AuditRequestContextException("error while getting context in the decoder", e);
    }
  }
  ...
  public String setAuditContext(String methodKey, Response response)
    ...
    try {
      ...
      throw new AuditRequestContextException("error while setting context in the error decoder", e);
    }
  }
